class Movimento{
  ...
  #define PNEU_VOLTA -40
	...
	void seguir(){robo.acionarMotores(PNEU_ANDA, PNEU_ANDA);}
 
	void girarParaEsquerda(){robo.acionarMotores(PNEU_VOLTA, PNEU_ANDA);}
 
  void girarParaDireita(){robo.acionarMotores(PNEU_ANDA, PNEU_VOLTA);}
